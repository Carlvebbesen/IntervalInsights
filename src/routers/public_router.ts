...
publicRouter.get("/privacy-policy", async (_c) => {
  const markdown = await Bun.file(new URL("../privacy_policy.md", import.meta.url).pathname).text();
...
publicRouter.get("/terms-of-service", async (_c) => {
